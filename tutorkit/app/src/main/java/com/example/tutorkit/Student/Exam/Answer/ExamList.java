package com.example.tutorkit.Student.Exam.Answer;
...
import com.example.tutorkit.Models.Question;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ValueEventListener listener = new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ExamList.this, "Can't connect", Toast.LENGTH_SHORT).show();
            }
        };
        ...
        submit.setOnClickListener(v -> {
            ...
            Intent i = new Intent(ExamList.this, Result.class);
