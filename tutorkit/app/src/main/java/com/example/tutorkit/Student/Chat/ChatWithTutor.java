...
public class ChatWithTutor extends AppCompatActivity {
    DatabaseReference databaseReference;
    RecyclerView recyclerView;
    ArrayList<Tutor> tutorArrayList;
    ChatTutorAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ChatTutorAdapter(ChatWithTutor.this, tutorArrayList);
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (idTutor.size() > 0) {
                            for (int i = 0; i < idTutor.size(); i++) {
                                databaseReference.child("tutors").child(idTutor.get(i))
                                        .addListenerForSingleValueEvent(new ValueEventListener() {
                                            @Override
                                            public void onDataChange(@NonNull DataSnapshot snapshot) {
