...
public class TutorGradeAdapter extends RecyclerView.Adapter<TutorGradeAdapter.ViewHolder> {

    Context context;
    ArrayList<Tutor> tutorArrayList;
    DatabaseReference databaseReference;

    public TutorGradeAdapter(Context context, ArrayList<Tutor> tutorArrayList) {
