...
import com.example.tutorkit.Tutor.Chat.Message.MessageAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (message.isEmpty()){
                    Toast.makeText(ChatTutorActivity.this, "Enter The Message First", Toast.LENGTH_SHORT).show();
                    return;
                }
                textmsg.setText("");
                Date date = new Date();
