...
public class Edit_student_profile extends AppCompatActivity {
    ...
    private void updateProfile(FirebaseUser firebaseUser) {
        ...
        if (TextUtils.isEmpty(name)) {
            ...
            Student student = new Student(name, DOB, gender, address,phone, phone_parent);
            // extract student reference from Database for register student
            ...
            databaseReference.child(studentID).setValue(student).addOnCompleteListener(new OnCompleteListener<Void>() {
                @Override
